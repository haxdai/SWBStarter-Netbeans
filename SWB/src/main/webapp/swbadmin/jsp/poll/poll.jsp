...
<%
        ...
        String webWorkPath = SWBPortal.getWebWorkPath() +  base.getWorkPath();
            ...
            if (dom != null) {
                ...
                if (!"".equals(base.getAttribute("question", "").trim()) && node.getLength() > 1) {
                    ...
                    if (display) {
                        %>
                            <p>
                            <a href="javascript:" onclick="abreResultados('<%=url.toString(true)%>')"><%=base.getAttribute("msg_viewresults", paramRequest.getLocaleString("msg_viewresults"))%></a>
                            </p>
                        <%
                    } else {
                        %>
