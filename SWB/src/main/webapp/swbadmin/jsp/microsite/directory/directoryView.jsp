                ...
                if("showcombo".equals(request.getParameter("mode")))
                {
                    ...
                    <div id="opcionesHeader" class="opt3">
                        <ul class="listaOpciones">
                            ...
                            <%=select.toString()%>
                            <button name="btnsubmit" type="submit">Agregar</button><button name="btnsubmit" type="button" onClick="Cancel('<%=paramRequest.getRenderUrl()%>');">Cancelar</button>
                            </form></li>
                        </ul>
                    </div>
...
<div class="twoColContent">
    ...
    {//Se desea filtrar informaci�n en los resultados
        while (itObjs.hasNext())
        {
            ArrayList alFilter = new ArrayList();
            DirectoryObject dirObj = itObjs.next();
    ...
    //Comienza ordenamiento de elementos, por defecto se ordena por t�tulo del elemento del directorio
    Set setResult = null;
    ...
    //Ya sabiendo cuantos y cuales son los elementos a listar (ya que puede ser una busqueda filtrada), se p�gina
...
if (!exist)
{
        ...
        <div class="listEntry" onmouseover="this.className='listEntryHover'" onmouseout="this.className='listEntry'">
            ...
            <div class="listEntryInfo">
                ...
                <p><span class="itemTitle">Creado por: </span>Tu nombre aqu�</p>
...
<%!
    //Funci�n utilizada para manejo de paginaci�n
