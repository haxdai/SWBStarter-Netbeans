...
<ul id="listaAlfabet">
    ...
    <li><a <%if (sparams != null && sparams.equals("�"))
            {%>class="active"<%}%> href="<%=urlAlphabetic.setParameter("alphabet", "�")%>">&Ntilde;</a></li>
    ...
    <div class="friendCard">
        ...
        <div class="friendCardInfo">
            ...
            <%
                String gender = "";
                String age = "";
                if (userprosp.getExtendedAttribute(mapa.get("userSex")) != null && !userprosp.getExtendedAttribute(mapa.get("userSex")).equals("null"))
                {
