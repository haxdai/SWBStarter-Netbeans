...
<script type="text/javascript">
    ...
    function validaForma()
    {
        ...
        if(!title)
        {
            alert('�Debe ingresar el t�tulo del evento!');
        ...
        if(!event_audience)
        {
            alert('�Debe ingresar la audiencia a la que est� dirigido el evento!');
        ...
        <div>
            <fieldset>
                ...
                <div>
                    ...
                    <p>
                        <label for="event_title">T�tulo del evento:&nbsp;</label><br />
                        <input type="text" id="event_title" name="event_title" maxlength="50" size="45" />
                    </p>
                    <p>
                        <label for="event_description">Descripci�n del evento:&nbsp;</label><br />
                    ...
                    <p>
                        ...
                        <input dojoType="dijit.form.DateTextBox" type="text" id="event_startDate" name="event_startDate" constraints="{datePattern:'dd/MM/yyyy'}" onChange="changeStartDate();"/>
                    </p>
                    <p>
                        <label for="event_endDate">Fecha de t�rmino:&nbsp;</label><br />
                        <input dojoType="dijit.form.DateTextBox" type="text" id="event_endDate" name="event_endDate" constraints="{datePattern:'dd/MM/yyyy'}" onChange="changeEndDate();"/>
                    </p>
                    <p>
                    ...
                    <p>
                        <label for="event_endTime">Hora de t�rmino:&nbsp;</label><br />
