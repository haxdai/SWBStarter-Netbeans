        ...
        <div class="noticiaTexto">
            ...
            <p>
                <script type="text/javascript">
                    ...
                    -->
                </script> | <a href="<%=viewUrl.toString(true)%>">Ver m�s</a>
                <%
...
<div class="columnaCentro">
    ...
    <%
            ...
            {
    %>
    <br/><br/><p><span class="tituloRojo">NOTA: </span>Si se suscribe a los eventos de la comunidad, recibir� una notificaci�n por correo electr�nico cuando alg�n miembro agrege o modifique alg�n evento.</p>
    <%            }
    %>
