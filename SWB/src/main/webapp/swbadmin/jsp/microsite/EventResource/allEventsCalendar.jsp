...
<%
    ...
    int offset = startOfMonth.get(Calendar.DAY_OF_WEEK) - Calendar.SUNDAY;
...
private  boolean isThisMonth(EventElement event, Calendar startOfM, Calendar endOfM) {
    ...
    //El evento inici� algun d�a de este mes?
    ...
    //El evento inici� antes del mes y termina despues del mes?
