...
<%@ page import="org.semanticwb.portal.resources.projectdriver.base.UserWebPageBase" %>
<%
        ...
        %>
                    <form id="frmUser" name="frmUser" action="<%=url.toString()%>" method ="post">
                        <div class="datosUsuario">
                            <div class="datosUsuIzq"><label for="<%=UserWebPageBase.swbproy_userWP.getName()%>"><%=UserWebPageBase.swbproy_userWP.getDisplayName(user.getLanguage())%> </label></div>
                            <div class="datosUsuDer"><%=userwp.getUserWP()!=null?userwp.getUserWP().getFullName():paramRequest.getLocaleString("msgUnassigned")%></div>
                            <div class="datosUsuIzq"><label for="<%=UserWebPageBase.swbproy_speciality.getName()%>"><%=UserWebPageBase.swbproy_speciality.getDisplayName(user.getLanguage())%> </label></div>
                            <%if(uservalid){
                            %><div class="datosUsuDer"><input id="<%=UserWebPageBase.swbproy_speciality.getName()%>" name="<%=UserWebPageBase.swbproy_speciality.getName()%>" value="<%=userwp.getSpeciality()!=null?userwp.getSpeciality():""%>" style="width:200px" ></div><%}else{%>
