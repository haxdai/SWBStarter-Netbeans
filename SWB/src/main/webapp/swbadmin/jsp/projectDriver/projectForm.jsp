...
<%@ page import="org.semanticwb.portal.resources.projectdriver.base.ProjectBase" %>
<%
    Iterator it;
...
<div id="proyecto">
      <div class="datosProyGral">
          <div class="datosProyIzqGral"><label for="<%=ProjectBase.swbproy_leader.getName()%>"><%=ProjectBase.swbproy_leader.getDisplayName(user.getLanguage())%> </label></div>
