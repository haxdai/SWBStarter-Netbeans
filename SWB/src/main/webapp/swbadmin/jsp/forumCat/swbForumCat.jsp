            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="crear_carta">
                        ...
                        <!-- <p class="maximo_caracteres"><b>Los mensajes y respuestas del foro deber�n ser aprobados antes de ser publicados.</b></p> -->
                        <p class="maximo_caracteres">M�ximo 2000 caracteres&nbsp;&nbsp;
                        </p>
                        <textarea name="teditor" id="teditor" cols="100" rows="2"></textarea>
                    </div>
                    <input type="button" onclick="validaforma();" class="boton" value="Publicar" />
...
<div class="foro_gral"> <!-- todo -->
    <p><strong><a href="<%=url%>">P�gina de inicio de los foros</a></strong></p>
    <%
                    }
                    int recPerPage = 5;
                ...
                <li class="grupo_respuestas_gral">
                    <div class="respuestas_gral">
                        ...
                        <div class="herramientas_foro_gral">
                            ...
                            %>
<%--
                            <a href="<%=actionURL.toString(true)%>"><img width="18" height="18" alt="�Eso qu�?" src="<%=defaultbaseimg%>icon_eso_que.png" /></a>(<%=favAnswer.getAnsIrrelevant()%>) �Esto qu&eacute;?
--%>
                            <%
                                                                                                                    /*}
                                                                                                                    else
                            ...
                            %>
<%--
                            <img width="18" height="18" alt="�Eso qu�?" src="<%=defaultbaseimg%>icon_eso_que.png"/>(<%=favAnswer.getAnsIrrelevant()%>) �Esto qu&eacute;?
--%>
                            <%
                                                                                        /*}
                                                                                    }*/
                ...
                <li class="grupo_respuestas_gral">
                    <div class="respuestas_gral">
                        ...
                        <div class="herramientas_foro_gral">
                            ...
                            %>
<%--
                            <a href="<%=actionURL.toString(true)%>"><img width="18" height="18" alt="�Eso qu�?" src="<%=defaultbaseimg%>icon_eso_que.png"/></a>(<%=comAnswer.getAnsIrrelevant()%>) �Esto qu&eacute;?
--%>
                            <%
                                                                                                                    /*}
                                                                                                                    else
                            ...
                            %>
<%--
                            <img width="18" height="18" alt="�Eso qu�?" src="<%=defaultbaseimg%>icon_eso_que.png"/>(<%=comAnswer.getAnsIrrelevant()%>) �Esto qu&eacute;?
--%>
                            <%
                                                                                        /*}
                                                                                    }*/
                ...
                <li class="grupo_respuestas_gral">
                    <div class="respuestas_gral">
                        ...
                        <div class="herramientas_foro_gral">
                            ...
                            %>
<%--
                            <a href="<%=actionURL.toString(true)%>"><img width="18" height="18" alt="�Eso qu�?" src="<%=defaultbaseimg%>icon_eso_que.png"/></a>(<%=answer.getAnsIrrelevant()%>) �Esto qu&eacute;?
--%>
                            <%
                                                                                                                                            /*}
                                                                                                                                            else
                            ...
                            %>
<%--
                            <img width="18" height="18" alt="�Eso qu�?" src="<%=defaultbaseimg%>icon_eso_que.png"/>(<%=answer.getAnsIrrelevant()%>) �Esto qu&eacute;?
--%>
                            <%
                                                                                                                /*}
                                                                                                            }*/
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="crear_carta">
                        ...
                        <!--<p class="maximo_caracteres"><b>Los mensajes y respuestas del foro deber�n ser aprobados antes de ser publicados.</b></p>-->
                        <p class="maximo_caracteres">M�ximo 2000 caracteres&nbsp;&nbsp;</p>
                        <textarea name="teditor" id="teditor" cols="100" rows="2"><%=content%></textarea>
                    </div>
                    <input type="button" onclick="validaforma();" class="boton" value="Modificar mensaje" />
                    <input type="button" class="boton" value="Regresar" onclick="history.go(-1);"/>
                </td>
            </tr>
        </table>
        ...
        <table border="0" cellspacing="0" cellpadding="0" id="redaccion">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="button" onClick="validaforma2();" class="boton" value="Publicar" />
                    <input type="button" class="boton" value="Regresar" onclick="history.go(-1);"/><br/>
                </td>
            </tr>
        </table>
    </form>
        ...
        <table border="0" cellspacing="0" cellpadding="0" id="redaccion">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="button" onClick="validaforma2();" class="boton" value="Modificar mensaje" />
                    <input type="button" class="boton" value="Regresar" onclick="history.go(-1);"/><br/>
                </td>
            </tr>
        </table>
...
<ul class="sfcQuestList">
    ...
    <li><div class="sfcQuest"><b><%=i%>. Mensaje por aprobar: </b><br/><h3><%=checkHTML(question.getQuestion())%></h3>
            <ul class="sfcInfo">
                <li>De:<%=question.getCreator() != null ? question.getCreator().getFullName() : "An�nimo"%></li>
                <li><%=fecha%></li>
            </ul>
            <%
    ...
    <li>
        ...
        <ul class="sfcAnsList">
            ...
            <li><div class="sfcAns"><b><%=i%>. Respuesta por aprobar: </b><br/><h3><%=checkHTML(answer.getAnswer())%></h3>
                    <ul class="sfcInfo">
                        <li>De:<%=answer.getCreator() != null ? answer.getCreator().getFullName() : "An�nimo"%></li>
                        <li><%=fecha%></li>
                    </ul>
                    <%
                                                                        String text = clean(answer.getAnswer(), 35);
...
<%
        ...
        %>
        <tr>
            <td><img src="<%=defaultbaseimg%>ico_conversacion.gif" alt="Icono de conversaci�n" /></td>
