                ...
                <fieldset>
                    ...
                    <ul class="btns_final">
                        <li>
                            ...
                            <%}%>
                            <input type="button" class="btn_form" value="Regresar" onclick="history.go(-1);">
                        </li>
                    </ul>
                </fieldset>
            </form>
                                                ...
                                                <ul>
                                                    ...
                                                    if (user.isSigned() && semanticBase.getBooleanProperty(SWBForumCatResource.forumCat_markIrrelevantAnswers)) {
                                                        if (!favAnswer.isAnonymous() && !favAnswer.getCreator().getURI().equals(user.getURI()) && !favAnswer.userHasVoted(user)) {
                                                             ...
                                                             %>
                                                             <li>
                                                                 �Esto qu&eacute;?<a href="<%=actionURL%>"><img width="18" height="18" alt="�Eso qu�?" src="<%=baseimg%>icon_eso_que.png" ></a>(<%=favAnswer.getAnsIrrelevant()%>)
                                                             </li>
                                                             <%
                                                        } else {
                                                           %>
                                                            <li>
                                                                 �Esto qu&eacute;?<img width="18" height="18" alt="�Eso qu�?" src="<%=baseimg%>icon_eso_que.png">(<%=favAnswer.getAnsIrrelevant()%>)
                                                            </li>
                                                             <%
                                                        }
                                                    }
                                                ...
                                                <ul>
                                                    ...
                                                    if (user.isSigned() && semanticBase.getBooleanProperty(SWBForumCatResource.forumCat_markIrrelevantAnswers)) {
                                                        if (!comAnswer.isAnonymous() && !comAnswer.getCreator().getURI().equals(user.getURI()) && !comAnswer.userHasVoted(user)) {
                                                             ...
                                                             %>
                                                             <li>
                                                                 �Esto qu&eacute;?<a href="<%=actionURL%>"><img width="18" height="18" alt="�Eso qu�?" src="<%=baseimg%>icon_eso_que.png"></a>(<%=comAnswer.getAnsIrrelevant()%>)
                                                             </li>
                                                             <%
                                                        } else {
                                                           %>
                                                           <li>
                                                                 �Esto qu&eacute;?<img width="18" height="18" alt="�Eso qu�?" src="<%=baseimg%>icon_eso_que.png">(<%=comAnswer.getAnsIrrelevant()%>)
                                                           </li>
                                                            <%
                                                        }
                                                    }
                                                ...
                                                <div class="herramientas_foro_gral">
                                                    ...
                                                    if (user.isSigned() && semanticBase.getBooleanProperty(SWBForumCatResource.forumCat_markIrrelevantAnswers)) {
                                                        if (!answer.isAnonymous() && !answer.getCreator().getURI().equals(user.getURI()) && !answer.userHasVoted(user)) {
                                                             ...
                                                             %>
                                                             <li>
                                                                 �Esto qu&eacute;?<a href="<%=actionURL%>"><img width="18" height="18" alt="�Eso qu�?" src="<%=baseimg%>icon_eso_que.png"></a>(<%=answer.getAnsIrrelevant()%>)
                                                             </li>
                                                             <%
                                                        } else {
                                                           %>
                                                           <li>
                                                                 �Esto qu&eacute;?<img width="18" height="18" alt="�Eso qu�?" src="<%=baseimg%>icon_eso_que.png">(<%=answer.getAnsIrrelevant()%>)
                                                            </li>
                                                             <%
                                                        }
                                                    }
