...
<%!
    public void notifica(User user,HttpServletRequest request,SWBParamRequest paramRequest,String titulo,WebPage newTema) throws IOException
    {
        ...
        if (role != null)
        {
            ...
            swbMail.setData("Se cre� el tema con el nombre " + titulo + " en el sitio: " + urilocal.toString());
...
%>
<p>El tema con t�tulo "<%=titulo%>" fue creada correctamente.</p>
<%
                    }
                    else
                    {
%>
<p>No se encontr� la p�gina de inicio de temas, favor de reportarlo con su admistrador de sitio.</p>
<%                                                    }
                ...
                {
%>
Ya existe un tema con ese nombre, intente otro t�tulo.
<%                                            }
            }
            else
            {
