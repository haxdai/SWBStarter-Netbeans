...
<%
    ...
    ResourceCalendar cal = (ResourceCalendar) objn.createGenericInstance();
        ...
        peticion_http.onreadystatechange = function() {
            if ((peticion_http.readyState == 4) && (peticion_http.status == 200)) {
                ...
                for (var Elemento in datos1) {
                    var ido2 = Number(value);
                    var ido = Number(Elemento);
                    ido = ido + ido2 -1;
    ...
    <div class="month">
        <div class="monthTitle">
            <div class="containerMonth">
                <span class="imgWidth"><a href="javascript:void(0);" onClick="changeMonth('prevmonth')"><img src="<%=org.semanticwb.SWBPlatform.getContextPath()%>/swbadmin/images/genericCalendar/btnAnt.png" border="0"/></a></span>
                <span class="currentMonth" id="currentMonth"></span>
                <span class="imgWidth"><a href="javascript:void(0);" onClick="changeMonth('nextmonth')"><img src="<%=org.semanticwb.SWBPlatform.getContextPath()%>/swbadmin/images/genericCalendar/btnSig.png" border="0"/></a></span>
            </div>
        </div>
    </div>
    <div class="weekdays">
...
<div class="optionsUser">
    ...
    <%if(isSubscriptor && cal.isCanSubscribed()) {%>
    ...
    <%} else if(user.isSigned() && cal.isCanSubscribed()){%>
