    ...
    <div class="month">
        <div class="monthTitle">
            <div class="containerMonthTumb">
                <span class="imgWidthTumb"><a href="javascript:void(0);" onClick="changeMonth<%=cal.getId()%>_tumb('prevmonth')"><img src="<%=org.semanticwb.SWBPlatform.getContextPath()%>/swbadmin/images/genericCalendar/img2.png" border="0"/></a></span>
                <span class="currentMonthTumb" id="<%=cal.getId()%>_thumcurrentMonth"></span>
                <span class="imgWidthTumb"><a href="javascript:void(0);" onClick="changeMonth<%=cal.getId()%>_tumb('nextmonth')"><img src="<%=org.semanticwb.SWBPlatform.getContextPath()%>/swbadmin/images/genericCalendar/img1.png" border="0"/></a></span>
            </div>
        </div>
    </div>
    <div class="weekdays">
