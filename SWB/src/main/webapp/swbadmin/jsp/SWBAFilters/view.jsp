                        ...
                        while(filters.hasNext()) {
                            ...
                            <tr>
                                ...
                                <td style="width:60px;">
                                    ...
                                    <a href="#" title="<%= paramRequest.getLocaleString("lblRemove") %>"
                                       onclick="if (confirm('<%= paramRequest.getLocaleString("msgDelete") %>')) {submitUrl('<%= remove %>',this); return false; } else { return false; }"><img
                                            src="<%= SWBPlatform.getContextPath() + "/swbadmin/images/delete.gif" %>"/></a>
                                </td>
                            </tr>
                            <%
                        }
