            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal" method="post" action="<%=actionURL%>" id="formSavePost">
                        ...
                        <%
                            Boolean isCaptcha = request.getAttribute("isCaptcha") != null && Boolean.parseBoolean(request.getAttribute("isCaptcha").toString());
                        %>
                        <%if (isCaptcha) {%>
...
<div class="row">
    <div class="col-lg-10 col-lg-offset-1">
        <div class="panel panel-default swbp-panel">
            <div class="panel-heading swbp-panel-title">
                <div class="panel-title">
                    <h1><span class="fa fa-bullhorn"></span> Foro
                    </h1>
                    <div class="text-right">
                        ...
                        <a class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Agregar tema" href="<%=url%>"><span class="fa fa-plus"></span></a>
                            ...
                            %>
                        <a href="<%=webpage.getParent().getUrl(lang)%>" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Herramientas de colaboraci�n">
                            <span class="fa fa-reply"></span>
                        </a>
                    </div>
                </div>
