...
<form method="post" action="<%=action%>">
    ...
    <table width="100%" cellpadding="2" cellspacing="2">
        ...
        <tr>
            <td>
                N�mero m�ximos de noticias a despluegar:
            </td>
            <td>
                <select name="numax">
                    <%
            ...
            <td>
                <%
                    if(simplemode)
                        {
                        %>
                            <input checked type="radio" name="modo" value="simplemode">S�&nbsp;&nbsp;&nbsp;
                        ...
                        {
                            %>
                            <input type="radio" name="modo" value="simplemode">S�&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td colspan="2"><input type="submit" value="Guardar"><input type="button" value="Cancelar" onClick="cancelar()"></td>
        </tr>
    </table>
</form>
