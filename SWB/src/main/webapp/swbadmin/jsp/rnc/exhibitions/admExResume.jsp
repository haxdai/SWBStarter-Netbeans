    ...
    <div class="swbform">
        <table width="100%"  border="0" cellpadding="5" cellspacing="0">
            <tr>
                ...
                <td class="valores"><%=base.getAttribute("criteria","")%></td>
            </tr>
			<tr>
			...
			<tr>
                ...
                <td class="valores"><%=base.getAttribute("endpointURL","").trim()%></td>
            </tr>
			<tr>
			...
			<tr>
                ...
                <td class="valores"><input type="text" name="title" disabled="disabled" size="40" value="<%=base.getAttribute("title","").trim()%>"/></td>
            </tr>
			<tr>
                <td class="datos">Favoritos: </td>
                <td class="valores"><%=base.getAttribute("favorites","").trim()%></td>
            </tr>
			<tr>
                <td class="datos">Ocultos: </td>
                <td class="valores"><%=base.getAttribute("hiddenarts","").trim()%></td>
            </tr>
            <tr>
