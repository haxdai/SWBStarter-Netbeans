...
%>
<p>Pregunta 3.- Una vez que valid� la informaci�n del "Punto de Partida" de los datos proporcionados por la SHCP, por favor registre los Montos correspondientes a cada una de las tres categor�as b�sicas de los costos de TI</p>
...
<form action="<%=url%>">
    ...
    <table>
        ...
        <tr>
            <td colspan="3">
                <p>
                    Pregunta 3-B:   De la suma mostrada para Outsourcing, �qu� porcentaje representa al personal (recursos humanos)? Esto incluye a los contratistas, personas que brindan servicios de mantenimiento u operativos, etc. En otras palabras, si la actividad cubierta por el Outsourcing (servicios contratados) se desarrollara dentro de la organizaci�n de TICs,  �qu� porcentaje de los costos corresponder�a a personal o recursos humanos?
                </p>
            </td>
        </tr>
