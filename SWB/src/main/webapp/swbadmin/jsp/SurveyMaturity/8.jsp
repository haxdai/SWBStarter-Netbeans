...
%>
<p>Pregunta 11: Por favor capture el porcentaje de incremento para cada a�o que usted prevea para todo el Portafolio de servicios de aplicaciones.<br>
    Pregunta 12: Por favor capture el porcentaje de incremento para cada a�o que usted prevea para todo el Portafolio de Servicios de Infraestructura.<br>
    Pregunta 13: Por favor capture el porcentaje de incremento para cada a�o que usted prevea para todo el Portafolio de Servicios a Usuarios.<br>
    Pregunta 14: Por favor capture el porcentaje de incremento para cada a�o que usted prevea para todo el Portafolio de Servicios de Gesti�n.<br>
    Pregunta 15: Por favor capture el porcentaje de incremento para cada a�o que usted prevea para todo el Portafolio de Servicios de Proyectos.<br>
</p>
    ...
    function valida(forma)
    {
        ...
        for (var i=0;i<x.length;i++)
        {
            ...
            if(name.startsWith('p_'))
            {
                ...
                {
                    title='Portafolio de Servicios de Gesti�n '+title;
                }
...
<form action="<%=url%>">
    ...
    <table width="100%" cellspacing="3">
        ...
        <tr>
            <td colspan="9">
                <p>
                    <b>Cambio porcentual anual del Portafolio de Servicios de  Gesti�n</b>
                </p>
            </td>
        </tr>
        <tr>
            <td>
                <p>Portafolio de Servicios de  Gesti�n</p>
            </td>
            <%
                        for (int i = 0; i < 8; i++)
                        {
