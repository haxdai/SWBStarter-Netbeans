...
%>
<p>
    Pregunta 22: Por favor estime el porcentaje del costo total de TIC (operaciones y desarrollo) en estas dos categor�as.
</p>
...
<form action="<%=url%>">
    ...
    <p>
        <b>Front Office.</b> Las actividades de Front Office de la Instituci�n son aquellas que est�n dirigidas a clientes u otras instituciones externas.<br>
        <b>Back Office.</b> Las actividades de Back Office de la Instituci�n son aquellas que no est�n dirigidas en forma espec�fica a clientes u otras dependencias externas, es decir, son el soporte interno.
