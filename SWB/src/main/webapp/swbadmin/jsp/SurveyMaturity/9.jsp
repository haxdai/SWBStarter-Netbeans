...
%>
<p>
    Pregunta 16: Enumere las cinco principales aplicaciones de la Instituci�n, determinadas por costo (soporte, mantenimiento, operaciones).<br>
    Pregunta 17: Indique para cada una de las cinco aplicaciones principales, el porcentaje del costo total del Portafolio de Servicios de Aplicaciones que le corresponde.  Adem�s, Por favor capture el porcentaje de incremento para cada a�o que usted prevea para esas cinco aplicaciones.
</p>
