...
<script type="text/javascript">
    ...
    {
        calcula(forma);
        if(!validaPorcentaje(forma.p_aplicacion_personal,'% del Costo de Personal de las Actividades de aplicaci�n'))
        {
            return;
        }
        if(!validaPorcentaje(forma.p_aplicacion_out,'% de Costos de Outsourcing de las Actividades de aplicaci�n'))
        {
            return;
        }
        if(!validaPorcentaje(forma.p_aplicacion_otros,'% de Otros Costos de las Actividades de aplicaci�n'))
        {
            return;
        }
        ...
        if(!validaPorcentaje(forma.p_admon_personal,'% del Costo de Personal de las Actividades de Administraci�n de TIC'))
        {
            return;
        }
        if(!validaPorcentaje(forma.p_admon_out,'% del Costo de Outsourcing de las Actividades de Administraci�n de TIC'))
        {
            return;
        }
        if(!validaPorcentaje(forma.p_admon_otros,'% de Otros Costos de las Actividades de Administraci�n de TIC'))
        {
            return;
        }
...
<p>Pregunta 4: Por favor capture �l % de cada uno de estos tres costos, que sean aplicables a cada �rea de Actividades.</p>
<form action="<%=url%>">
    ...
    <table>
        ...
        <th>% del Costo de Personal en cada �rea de Actividad</th>
        <th>% de Costos de Outsourcing en cada �rea de Actividad</th>
        <th>% de Otros Costos en cada �rea de Actividad</th>
        ...
        <tr>
            <td>
                Actividades de Administraci�n de TIC
            </td>
            <td>
