    ...
    function valida(forma)
    {
        ...
        for (var i=0;i<x.length;i++)
        {
            ...
            if(name.startsWith('p_'))
            {
                ...
                {
                    str_title='% de los Costos del Portafolio de Servicios de Gesti�n de TIC para '+str_title;
                }
        ...
        {
            alert('El % TOTAL de los Costos del Portafolio de Servicios de Gesti�n de TIC no puede ser mayor de 100%');
            return;
        }

        if(parseInt(t_gestion_)<100)
        {
            alert('El % TOTAL de los Costos del Portafolio de Servicios de Gesti�n de TIC debe sumar 100%');
            return;
        }
...
<form action="<%=url%>">
    ...
    <table>
        <legend>Conformaci�n de los Costos de TIC de las Unidades Sustantivas</legend>
        ...
        <th>% de los Costos del Portafolio de Servicios de Gesti�n de TIC para cada Unidad Sustantiva</th>
