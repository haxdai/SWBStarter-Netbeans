...
<%
            ...
            settramites.add(new TramiteInfo("Tr�mite 1", "522"));
            tramites.put("59", settramites);
            settramites = new HashSet<TramiteInfo>();
            settramites.add(new TramiteInfo("Tr�mite 1", "245"));
            tramites.put("60", settramites);
%>
<p>
    Pregunta 7: Por favor capture el porcentaje de las actividades del tr�mite, que sea soportado por TIC.<br>
    Pregunta 8: Por favor capture la cantidad anual de tr�mites que se realizan para cada uno de los Tr�mites de Alto Impacto.<br>
    Pregunta 9:  Considerando los Costos Totales de Servicios de Aplicaciones para la Instituci�n, por favor estime el % de esos Costos que son asignables a cada tr�mite.<br>
    Pregunta 10: Considerando los Costos Totales de Servicios de Infraestructura para la Instituci�n, por favor estime el % de esos Costos que son asignables a cada tr�mite.<br>
</p>
<script type="text/javascript">
    ...
    function valida(forma)
    {
        ...
        {
            alert('El % TOTAL del Tr�mite apoyado por TIC no puede ser mayor a 100%');
            return;
        }
        if(parseInt(t_tramite_apoyado_)<100)
        {
            alert('El % TOTAL del Tr�mite apoyado por TIC no puede ser menor a 100%');
            return;
        }
        ...
        {
            alert('El % TOTAL de Costos de Servicio de Aplicaci�n no puede ser mayor a 100%');
            return;
        }
        if(parseInt(t_aplicacion_)<100)
        {
            alert('El % TOTAL de Costos de Servicio de Aplicaci�n no puede ser menor a 100%');
            return;
        }
...
<form action="<%=url%>">
    ...
    <table>
        ...
        <th>
            Tr�mite de Alto Impacto
        </th>
        <th>
            % del Tr�mite apoyado por TIC
        </th>
        <th>
            N�mero de Tr�mites Anuales
        </th>
        <th>
            % de Costos de Servicio de Aplicaci�n
        </th>
        <th>
        ...
        <tr>
            ...
            <td>
                <p>Todas los dem�s</p>
                <input type="hidden" name="title_tramite_" value="Todas los dem�s">
            </td>
            <td>
