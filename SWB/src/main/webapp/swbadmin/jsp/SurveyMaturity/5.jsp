...
<script type="text/javascript">
    ...
    function valida(forma)
    {
        ...
        if(!validaPorcentaje(forma.p_soporte, '% de Costos de Operaciones e Infraestructura para Actividades de Soporte T�cnico a Usuarios'))
        {
            return;
        }
        if(!validaPorcentaje(forma.p_admon, '% de Costos de Operaciones e Infraestructura para Actividades de Gesti�n de TIC'))
        {
            return;
        }
